...
notify-send -e -a niri -i "/home/${USER}/.local/share/misc/niri-icon.svg" "NEA configuration" "Initing window positions"
...
notify-send -e -a niri -i "/home/${USER}/.local/share/misc/niri-icon.svg" "NEA configuration" "Restoring window positions"
...
notify-send -e -a niri -i "/home/${USER}/.local/share/misc/niri-icon.svg" "NEA configuration" "Window positions restored"