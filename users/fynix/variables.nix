    ...
    kanata.keyboards = {
      fydetabduo = {
        ...
        config = ''
          ...
          (deflayer mouse
            _    _    _    _    _    _    _    _    _    _    _    _    _    _
            _    lmet (mwheel-left 20 60) (movemouse-accel-up 10 750 1 4) (mwheel-right 20 60) lalt _    @zmin (mwheel-down 30 60) (mwheel-up 30 60) @zmout _    _
            _    lsft (movemouse-accel-left 10 750 1 4) (movemouse-accel-down 10 750 1 4) (movemouse-accel-right 10 750 1 4) lctl _    mlft mrgt (layer-toggle mouse-slow) _    _    _
