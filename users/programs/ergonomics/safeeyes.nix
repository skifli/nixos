...
>>>>>>> 0f6ee69 (feat(safeeyes): define config file)
      }))
    ];

    # SafeEyes JSON Configuration
    xdg.configFile."safeeyes/safeeyes.json" = {
      text = ''
        {
          "allow_postpone": true,
          ...
          "plugins": [
              ...
              },
              {
                  ...
                  "settings": {
                      "number_of_allowed_skips_in_a_row": 2.0
                  },
                  "version": "0.0.1"
              }
          ],
