...
| `fydetab` | `aarch64-linux` | Panthor  | FydeTab Duo, uses [fyde-nix](https://github.com/NixOnFyde/fyde-nix) hardware module. |
...
| `fynix`  | FydeTab user           | `zsh`         | Niri + Wayle + Vicinae + Ghostty + Zen Browser |
